...
class Report:
    ...
    def generate_image_demand(self):
        ...
        plt.savefig('/home/ermakov/PycharmProjects/Android_dev/static/graph2.png', dpi=300)
    ...
    def generate_image_geo(self):
        ...
        plt.savefig('/home/ermakov/PycharmProjects/Android_dev/static/graph3.png', dpi=300)


def demand(request):
    filename = '/home/ermakov/PycharmProjects/Android_dev/templates/data/vacancies_with_skills.csv'
    name_vacancy = "Android"
...
vacancy_choices = '|'.join(['android', 'андроид', 'andorid', 'andoroid', 'andriod', 'andrind', 'xamarin'])
data = pd.read_csv('/home/ermakov/PycharmProjects/Android_dev/templates/data/vacancies_with_skills.csv', usecols=['name', 'key_skills', 'published_at'])
...
def last_vacansies(request):
    return render(request, "last_vacancies.html", context={"vacansies": get_vacancies(), })
